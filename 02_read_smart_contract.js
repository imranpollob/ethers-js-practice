...
async function main() {
  ...
  const balance = await contract.balanceOf("0x57C1e0C2ADf6EECDb135BcF9ec5F23b319be2c94");
  console.log(`Balance of 0x57C1e0C2ADf6EECDb135BcF9ec5F23b319be2c94: ${balance} Wei : ${ethers.utils.formatEther(balance)} Ether`);
}
